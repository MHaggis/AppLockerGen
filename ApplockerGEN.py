...
with col1:
    ...
    2️⃣ <a href="Applocker_Combiner" target="_self">**Policy Merging**</a>: Combine multiple AppLocker policies into one comprehensive set of rules. This tool helps you combine multiple AppLocker policies into a single policy file. 🧩
